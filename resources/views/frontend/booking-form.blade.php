                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="booking_advanced">
                            ...
                            <div class="main_title a_left upper">
                                <h2>{{translate('Book Online')}}</h2>
                            </div>

                            <!-- <div class="succes">
                                <span>Succesfully Booking</span>
                            </div>
                            <div class="fail">
                                <span>Some Thing Is Wrong</span>
                            </div> -->
                            <div id="notification">
                            ...
                            <!-- ========== BOOKING FORM ========== -->
                                ...
                                <form id="booking_form_advanced" action="{{route('booking.store')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="booking-name" type="text" class="form-control" placeholder="{{translate('Your Name')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="booking-phone" type="text" class="form-control" placeholder="{{translate('Your Phone Number')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form_select">
                                                <select name="booking-country" class="form-control" title="Select Your Country" data-header="{{translate('Select Your Country')}}" data-live-search="true" data-size="5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form_date1">
                                                <input type="text" class="datepicker form-control" id="arrival" name="booking-checkin" placeholder="{{translate('Arrival Date')}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{translate('Departure')}}
                                                <a href="#" title="Departure" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="{{translate('Check Out from 12:00 am')}}"> <i class="label_icon_info fa fa-info-circle"></i></a>
                                            </label>
                                            <div class="form_date1">
                                                <input type="text" class="datepicker form-control"  name="booking-checkout" placeholder="{{translate('Departure Date')}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>{{translate('Your Comments')}}</label>
                                            <textarea class="form-control" name="booking-comments" placeholder="Your Comments..."></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <button type="submit" class="button btn_blue pull-right"> <i class="fa fa-calendar-check-o" aria-hidden="true"></i> BOOK A ROOM </button>
                                    </div>
                                    </div>
                                </form>
                    ...
                    <div class="col-md-4">
                        <div class="special_offers">
                            <div class="main_title a_left upper">
                                <h2>{{translate('Special Offers')}}</h2>
                            </div>
                            @foreach($roomF->slice(0,3) as $room)
                            <article class="room mb40">
                                <figure>
                                    <a href="{{route('room',$room->id)}}" class="hover_effect h_blue h_link">
                                        <img src="{{$room->image}}" class="img-responsive" alt="Image" style="height:262px;">
                                    </a>
                                    <figcaption>
                                        <h4><a href="{{route('room',$room->id)}}">{{translate(table('room_categories','id',$room->category_id,'category_name'))}}</a></h4>
                            ...
                            <!-- <article class="room mb40">
                                <figure>
                                    <a href="room.html" class="hover_effect h_blue h_link">
                                        <img src="{{asset('')}}frontend/images/rooms/special2.jpg" class="img-responsive" alt="Image">
                                    </a>
                                    <figcaption>
                            ...
                            <article class="room mb40">
                                <figure>
                                    <a href="room.html" class="hover_effect h_blue h_link">
                                        <img src="{{asset('')}}frontend/images/rooms/special3.jpg" class="img-responsive" alt="Image">
                                    </a>
                                    <figcaption>
