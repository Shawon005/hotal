...
<head>
    ...
    <!-- ========== GOOGLE FONTS ========== -->
    <link href="{{asset('')}}frontend/https://fonts.googleapis.com/css?family=Lato:300,400,700,900%7cRaleway:400,500,600,700" rel="stylesheet">
...
<body class="full_screen">
    ...
    <main id="error404_fullscreen_page" class="gradient_overlay dotted_overlay">
        <div class="inner container">
            ...
            <div class="a_center">
                <a href="{{asset('')}}frontend/index.html" class="button btn_sm btn_yellow"><i class="fa fa-angle-left"></i> GO BACK TO HOME PAGE</a> <span class="or">OR</span>
                <a href="{{asset('')}}frontend/contact.html" class="button btn_sm btn_yellow">CONTACT US &nbsp;<i class="fa fa-envelope-o"></i></a>
                <div class="social_media a_center mt50">
                    <a class="facebook" href="{{asset('')}}frontend/#"><i class="fa fa-facebook"></i></a>
                    <a class="twitter" href="{{asset('')}}frontend/#"><i class="fa fa-twitter"></i></a>
                    <a class="googleplus" href="{{asset('')}}frontend/#"><i class="fa fa-google-plus"></i></a>
                    <a class="pinterest" href="{{asset('')}}frontend/#"><i class="fa fa-pinterest"></i></a>
                    <a class="linkedin" href="{{asset('')}}frontend/#"><i class="fa fa-linkedin"></i></a>
                    <a class="youtube" href="{{asset('')}}frontend/#"><i class="fa fa-youtube"></i></a>
                    <a class="instagram" href="{{asset('')}}frontend/#"><i class="fa fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </main>
    ...
    <script type="text/javascript" src="{{asset('')}}frontend/https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY"></script>
