...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>{{translate($setting->site_title)}}</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
        <div class="top_menu">
            <div class="container">
                <div class="welcome_mssg hidden-xs">
                    {{translate('Welcome to')}} {{translate($setting->site_title)}}
                </div>
                <ul class="top_menu_right">
                    ...
                    <li class="language-switcher">
                        <nav class="dropdown">
                            <a href="{{route('lang','en')}}" class="dropdown-toggle select" data-hover="dropdown" data-toggle="dropdown">
                               Language<b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="{{route('lang','english')}}"><i class="famfamfam-flag-gb"></i>English</a></li>
                                <li><a href="{{route('lang','swedish')}}"><i class="famfamfam-flag-se"></i>Swedish</a></li>
                                <li><a href="{{route('lang','spanish')}}"><i class="famfamfam-flag-es"></i>Spainsh</a></li>
                                <li><a href="{{route('lang','french')}}"><i class="famfamfam-flag-fr"></i>french</a></li>
                                <li><a href="{{route('lang','german')}}"><i class="famfamfam-flag-de"></i>german</a></li>
                                <li><a href="{{route('lang','arabic')}}"><i class="famfamfam-flag-sa"></i>arabic</a></li>
                                <li><a href="{{route('lang','persian')}}"><i class="famfamfam-flag-ir"></i>persian</a></li>
        ...
        @include('frontend.layout.partial.top2')
        @yield('content')  
