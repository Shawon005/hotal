            ...
            <div class="container">
                ...
                <ul class="top_menu_right">
                    ...
                    <li class="language-switcher">
                        <nav class="dropdown">
                            <a href="{{route('lang','swedish')}}" class="dropdown-toggle select" data-hover="dropdown" data-toggle="dropdown">
                            <i class="famfamfam-flag-se"></i>
                            Swedish<b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li class=""><a href="{{route('lang','english')}}"><i class="famfamfam-flag-gb"></i>English</a></li>
