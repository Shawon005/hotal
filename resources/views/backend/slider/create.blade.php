                            ...
                            <div class="content controls">
                                <form action="{{route('admin.slider.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9"><input type="text" class="form-control" name="sub_title" placeholder="text value"/></div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-3">Button Name</div>
                                        <div class="col-md-9"><input type="text" class="form-control" name="btn_text" placeholder="text value"/></div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-3">Button URL</div>
                                        <div class="col-md-9"><input type="URL" class="form-control" name="btn_link" placeholder="https://www.test.com"/></div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-3">Serial Number</div>
                                        <div class="col-md-9">
                                            <input id="spinner" class="form-control" name="serial_no" placeholder="0"/>
                                        </div>
                                    </div>
