                    ...
                    <div class="col-md-12">
                        ...
                        <div class="block block-fill-white">
                            <div class="header">
                                ...
                                <span class="pull-right"><a href="package-manage-addcategories.html" type="button" class="btn btn-primary"><i class="icon-fixed-width icon-plus"></i>Add Catagories</a> </span>                                         
                            </div>
                            <div class="content">
