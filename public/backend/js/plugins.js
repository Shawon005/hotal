$(document).ready(function(){
    ...
    $( '#multiple-select-field' ).select2( {
        theme: "bootstrap-3",
        width: $( this ).data( 'width' ) ? $( this ).data( 'width' ) : $( this ).hasClass( 'w-100' ) ? '800px' : 'style',
    ...
    if($("table.sortable").length > 0)
        // $("table.sortable").dataTable({"iDisplayLength": 6, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null, null]});    
        $("table.sortable").dataTable({"aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers"});    
    /* eof Datatables */
